...
const copy = {
  ja: {
    ...
    scannerDescription: '画像規格を確認後、スクショを解析します。通知バッジや予定などの検出結果は、投稿前のプレビューで確認・編集できます。',
    ...
    confirmDesc: '検出されたアプリやウィジェットを確認し、画像上のプライバシーぼかし（黒塗り・ぼかし領域）も必要に応じて追加・削除できます。',
    cancelLabel: 'やり直す',
  ...
  en: {
    ...
    scannerDescription: 'We check the image format, then analyze your screenshot. Review detected notification badges, events, and private text in the preview before publishing.',
    selectedLabel: 'Selected',
    ...
    confirmDesc: 'Review detected apps and widgets, then add, edit, or remove privacy masking areas directly on the preview image.',
    cancelLabel: 'Cancel',
